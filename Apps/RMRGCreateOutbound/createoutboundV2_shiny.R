#Rocky Mountain Recovery Group 8/28/14
#Function for creating outbound data files to vendors in Shiny App

createoutbound <- function(master, filechoice){
